    ...
    egui::Window::new("Tnua").show(egui_context.ctx_mut(), |ui| {
        ...
        ) in query.iter_mut()
        {
            egui::CollapsingHeader::new(name)
                ...
                .show(ui, |ui| {
                    ui.add(
                        egui::Slider::new(&mut platformer_config.spring_strengh, 0.0..=400.0)
                            .text("Spring Strengh"),
                    );
                    ui.add(
                        egui::Slider::new(&mut platformer_config.spring_dampening, 0.0..=40.0)
                    ...
                    ui.add(egui::Slider::new(&mut speed_control.0, 0.0..=30.0).text("Speed"));
                });
        }
    });
}
