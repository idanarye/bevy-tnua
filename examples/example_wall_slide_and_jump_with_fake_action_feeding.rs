...
fn apply_controls(
    ...
    if keyboard.pressed(KeyCode::Space) {
        ...
        // Instead of trying to determine which action needs faking, just fake both. The "real"
        // action won't be affected by that, since it was already fed.
        controller.action_fake(ControlSchemeActionDiscriminant::Jump);
        controller.action_fake(ControlSchemeActionDiscriminant::WallJump);
    }
}
