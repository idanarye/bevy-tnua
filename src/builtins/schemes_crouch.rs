...
#[derive(Clone)]
pub struct Tnua2BuiltinCrouchConfig {
...
impl Default for Tnua2BuiltinCrouchConfig {
    fn default() -> Self {
        Self {
            float_offset: 0.0,
...
pub enum Tnua2BuiltinCrouchMemory {
...
impl<B: Tnua2Basis> Tnua2Action<B> for Tnua2BuiltinCrouch
where
        ...
        match lifecycle_status {
            ...
            TnuaActionLifecycleStatus::CancelledInto => {
                if !self.uncancellable {
                    *memory = Tnua2BuiltinCrouchMemory::Rising;
                }
            }
        }
