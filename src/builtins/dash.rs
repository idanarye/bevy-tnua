...
pub struct TnuaBuiltinDash {
    ...
    pub brake_to_speed: TargetFloat,
    ...
    pub brake_acceleration: TargetFloat,
...
impl TnuaAction for TnuaBuiltinDash {
    ...
    fn initiation_decision(
        ...
        if !self.displacement.is_finite() || self.displacement == TargetVec3::ZERO {
            ...
            return match state {
                TnuaBuiltinDashState::PreDash => {
                    ...
                    *state = TnuaBuiltinDashState::During {
                        ...
                        consider_blocked_if_speed_is_less_than: TargetFloat::NEG_INFINITY,
                    };
                    continue;
                }
...
pub enum TnuaBuiltinDashState {
    ...
    During {
        ...
        destination: TargetVec3,
        desired_forward: TargetVec3,
        consider_blocked_if_speed_is_less_than: TargetFloat,
    },
    Braking {
        direction: TargetVec3,
    },
